...
@section('content')
    <div class="container bg-gray-700 rounded-xl py-8 max-w-6xl mx-auto mt-6 md:mt-20">
        <div class="max-w-4xl mx-auto md:grid md:grid-cols-12 gap-x-10 pt-10">
            <div class="col-span-4 text-center">
                ...
                <div class="mt-4 block text-gray-400 font-semibold text-xs">
                    Published 1 day ago
                </div>
            ...
            <div class="col-span-8">
                <div class="flex justify-between -mt-10">
                    <a href="#" class="relative inline-flex items-center text-base hover:text-blue-500 transition duration-150 ease-in">
                    ...
                    <div class="space-x-2">
                        ...
                        <button class="bg-green-800 border border-green-800 hover:border-green-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-3 py-1">Random</button>
                    </div>
                </div>
